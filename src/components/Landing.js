  ...
  const LandingJSX = (
    <div className="landing-section bg-gray-900 flex flex-col justify-center items-center md:h-screen md:w-screen text-gray-100 ">
      <div className="flex flex-col justify-center items-center mx-auto my-auto">
        ...
        <button className="text-lg text-gray-300 tracking-tight md:mt-6 border border-gray-600 bg-opacity-75 p-2 rounded hover:shadow-lg transition duration-500 ease-in-out transform hover:border-2 hover:scale-105 hover:border-cyberlightblue">
          VIEW PROJECTS
        </button>
        <h1 className="flex tracking-wide justify-center items-center text-xl md:mt-6 ">
          or keep scrolling
